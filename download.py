...
def get_products(access_token):
    ...
    filtered_products = [p for p in products if 'greenplum' in p['name'].lower() or 'postgres' in p['name'].lower() or 'rabbit' in p['name'].lower() or 'data' in p['name'].lower() or 'lake' in p['name'].lower()] 
