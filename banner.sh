...
echo
echo -e "${BLUE}${BOLD}1. To download software:${RESET}"
echo -e "   Use ${CYAN}download.py${RESET} (alias: ${MAGENTA}gpdownload${RESET})."
echo
echo -e "${BLUE}${BOLD}2. To check the current Greenplum version:${RESET}"
echo -e "   Run ${CYAN}List_Version.sh${RESET} (alias: ${MAGENTA}gpdb${RESET})."
echo
echo -e "${BLUE}${BOLD}3. To reinitialize Greenplum installation:${RESET}"
